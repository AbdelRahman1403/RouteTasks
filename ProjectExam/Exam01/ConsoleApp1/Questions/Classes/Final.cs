...
namespace ConsoleApp1.Questions.Classes
{
    public class Final : IExamable
    {
        ...
        public Final(int examTime, int questionCount, int Answerscount, string Name, int ID)
        {
            SubjectID = ID;
            SubjectName = Name;
            ExamTime = examTime;
        ...
        public virtual void ImplementExam()
        {
            for (int i = 0; i < questions.Length; i++)
            {
                Console.WriteLine("What type of Question do you want\n 1:Multiple Choices\n 2:True and False");
                int choice;
                do
                {
                ...
                if (questions[i].AnswersList is not null)
                {
                    ...
                    {
                        questions[i].SetTrueFalseQuestion();
                    }
                }
                Console.Clear();
            }
